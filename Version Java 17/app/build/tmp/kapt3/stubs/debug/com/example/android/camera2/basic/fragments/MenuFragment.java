...
public final class MenuFragment extends androidx.fragment.app.Fragment {
    ...
    private final int adjustRotationForDisplay(int sensorOrientation, int displayRotation) {
        return 0;
    }
    
    private final int orientationFunction(int orientation) {
        return 0;
    }
}