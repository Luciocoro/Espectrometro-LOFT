...
public final class MedirAbsorbanciaTest extends androidx.fragment.app.Fragment {
    ...
    private int fotoNro = 0;
    private java.util.List<java.util.List<java.lang.Float>> grisesSinMuestra;
    private java.util.List<java.util.List<java.lang.Float>> grisesConMuestra;
    private java.util.List<java.lang.Float> grisLoopActual;
    ...
    private final void testFloatMatrixParcelable() {
    }
