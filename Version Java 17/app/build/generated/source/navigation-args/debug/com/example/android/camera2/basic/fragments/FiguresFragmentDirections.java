...
public class FiguresFragmentDirections {
  private FiguresFragmentDirections() {
  }

  @NonNull
  public static ActionFiguresFragmentToPerfiles actionFiguresFragmentToPerfiles(
    ...
    return new ActionFiguresFragmentToPerfiles(cameraId, blueOrder1, redOrder1, greenOrder1, grisesSinMuestra, grisesConMuestra, blueOrder2, redOrder2, greenOrder2, listaIndices, posicionEnXOrden0, posicionEnXMaxBlue1, numberOfPictures, exposureTime, sensitivity, focalDistance);
  }

  public static class ActionFiguresFragmentToPerfiles implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionFiguresFragmentToPerfiles(@NonNull String cameraId, @NonNull float[] blueOrder1,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setCameraId(@NonNull String cameraId) {
      if (cameraId == null) {
        throw new IllegalArgumentException("Argument \"camera_id\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("camera_id", cameraId);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setBlueOrder1(@NonNull float[] blueOrder1) {
      if (blueOrder1 == null) {
        throw new IllegalArgumentException("Argument \"blueOrder1\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("blueOrder1", blueOrder1);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setRedOrder1(@NonNull float[] redOrder1) {
      if (redOrder1 == null) {
        throw new IllegalArgumentException("Argument \"redOrder1\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("redOrder1", redOrder1);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setGreenOrder1(@NonNull float[] greenOrder1) {
      if (greenOrder1 == null) {
        throw new IllegalArgumentException("Argument \"greenOrder1\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("greenOrder1", greenOrder1);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setGrisesSinMuestra(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setGrisesConMuestra(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setBlueOrder2(@NonNull float[] blueOrder2) {
      if (blueOrder2 == null) {
        throw new IllegalArgumentException("Argument \"blueOrder2\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("blueOrder2", blueOrder2);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setRedOrder2(@NonNull float[] redOrder2) {
      if (redOrder2 == null) {
        throw new IllegalArgumentException("Argument \"redOrder2\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("redOrder2", redOrder2);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setGreenOrder2(@NonNull float[] greenOrder2) {
      if (greenOrder2 == null) {
        throw new IllegalArgumentException("Argument \"greenOrder2\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("greenOrder2", greenOrder2);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setListaIndices(@NonNull float[] listaIndices) {
      if (listaIndices == null) {
        throw new IllegalArgumentException("Argument \"listaIndices\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("listaIndices", listaIndices);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setPosicionEnXOrden0(int posicionEnXOrden0) {
      this.arguments.put("posicionEnXOrden0", posicionEnXOrden0);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setPosicionEnXMaxBlue1(int posicionEnXMaxBlue1) {
      this.arguments.put("posicionEnXMaxBlue1", posicionEnXMaxBlue1);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setNumberOfPictures(int numberOfPictures) {
      this.arguments.put("numberOfPictures", numberOfPictures);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setExposureTime(long exposureTime) {
      this.arguments.put("exposureTime", exposureTime);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setSensitivity(int sensitivity) {
      this.arguments.put("sensitivity", sensitivity);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFiguresFragmentToPerfiles setFocalDistance(float focalDistance) {
      this.arguments.put("focalDistance", focalDistance);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.action_figuresFragment_to_perfiles;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionFiguresFragmentToPerfiles that = (ActionFiguresFragmentToPerfiles) object;
    ...
    public String toString() {
      return "ActionFiguresFragmentToPerfiles(actionId=" + getActionId() + "){"
