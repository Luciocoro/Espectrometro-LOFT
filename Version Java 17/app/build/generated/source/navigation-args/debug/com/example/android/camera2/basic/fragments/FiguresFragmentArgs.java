...
public class FiguresFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private FiguresFragmentArgs() {
  }

  @SuppressWarnings("unchecked")
  private FiguresFragmentArgs(HashMap argumentsMap) {
  ...
  public static FiguresFragmentArgs fromBundle(@NonNull Bundle bundle) {
    FiguresFragmentArgs __result = new FiguresFragmentArgs();
    bundle.setClassLoader(FiguresFragmentArgs.class.getClassLoader());
  ...
  @NonNull
  @SuppressWarnings("unchecked")
  public static FiguresFragmentArgs fromSavedStateHandle(
  ...
  public boolean equals(Object object) {
    ...
    FiguresFragmentArgs that = (FiguresFragmentArgs) object;
  ...
  public static final class Builder {
    ...
    @SuppressWarnings("unchecked")
    public Builder(@NonNull FiguresFragmentArgs original) {
    ...
    @NonNull
    public FiguresFragmentArgs build() {
      FiguresFragmentArgs result = new FiguresFragmentArgs(arguments);
      return result;
    }
