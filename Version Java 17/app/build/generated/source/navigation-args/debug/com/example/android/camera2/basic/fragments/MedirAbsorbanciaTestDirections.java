...
public class MedirAbsorbanciaTestDirections {
  private MedirAbsorbanciaTestDirections() {
  }
  ...
  public static class ActionMedirAbsorbanciaTestToCaptura implements NavDirections {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMedirAbsorbanciaTestToCaptura setBitmap(@NonNull Bitmap bitmap) {
      if (bitmap == null) {
        throw new IllegalArgumentException("Argument \"bitmap\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("bitmap", bitmap);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMedirAbsorbanciaTestToCaptura setCameraId(@NonNull String cameraId) {
      if (cameraId == null) {
        throw new IllegalArgumentException("Argument \"camera_id\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("camera_id", cameraId);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMedirAbsorbanciaTestToCaptura setBlueOrder1(@NonNull float[] blueOrder1) {
      if (blueOrder1 == null) {
        throw new IllegalArgumentException("Argument \"blueOrder1\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("blueOrder1", blueOrder1);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMedirAbsorbanciaTestToCaptura setRedOrder1(@NonNull float[] redOrder1) {
      if (redOrder1 == null) {
        throw new IllegalArgumentException("Argument \"redOrder1\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("redOrder1", redOrder1);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMedirAbsorbanciaTestToCaptura setGreenOrder1(@NonNull float[] greenOrder1) {
      if (greenOrder1 == null) {
        throw new IllegalArgumentException("Argument \"greenOrder1\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("greenOrder1", greenOrder1);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMedirAbsorbanciaTestToCaptura setBlueOrder2(@NonNull float[] blueOrder2) {
      if (blueOrder2 == null) {
        throw new IllegalArgumentException("Argument \"blueOrder2\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("blueOrder2", blueOrder2);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMedirAbsorbanciaTestToCaptura setRedOrder2(@NonNull float[] redOrder2) {
      if (redOrder2 == null) {
        throw new IllegalArgumentException("Argument \"redOrder2\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("redOrder2", redOrder2);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMedirAbsorbanciaTestToCaptura setGreenOrder2(@NonNull float[] greenOrder2) {
      if (greenOrder2 == null) {
        throw new IllegalArgumentException("Argument \"greenOrder2\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("greenOrder2", greenOrder2);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMedirAbsorbanciaTestToCaptura setListaIndices(@NonNull float[] listaIndices) {
      if (listaIndices == null) {
        throw new IllegalArgumentException("Argument \"listaIndices\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("listaIndices", listaIndices);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMedirAbsorbanciaTestToCaptura setPosicionEnXOrden0(int posicionEnXOrden0) {
      this.arguments.put("posicionEnXOrden0", posicionEnXOrden0);
      return this;
    }
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionMedirAbsorbanciaTestToCaptura setPosicionEnXMaxBlue1(int posicionEnXMaxBlue1) {
      this.arguments.put("posicionEnXMaxBlue1", posicionEnXMaxBlue1);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.actionMedirAbsorbanciaTestToCaptura;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionMedirAbsorbanciaTestToCaptura that = (ActionMedirAbsorbanciaTestToCaptura) object;
